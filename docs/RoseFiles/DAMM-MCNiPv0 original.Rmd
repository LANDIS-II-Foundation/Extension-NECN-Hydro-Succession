...
```{r}
parameters <- read.csv(paste0(getwd(),"/parameters-original.csv"))

inputdata <- read.csv(paste0(getwd(),"/inputdata-original.csv"))
```

Set up model run
```{r}
p = parameters$default #select either default parameters or fitted to 2009 flux data
